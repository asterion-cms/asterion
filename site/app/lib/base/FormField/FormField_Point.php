    ...
    public static function create($options)
    {
        ...
        switch ($layout) {
            ...
            case 'map':
                ...
                $showHideMap = (isset($options['showHideMap']) && $options['showHideMap'] == 'true') ? FormField::create('checkbox', ['label' => __('showHideMap'), 'class' => 'showHide']) : '';
                return '<div class="point pointMap form_field ' . $class . ' ' . $errorClass . '" data-initlat="' . Params::param('initLat') . '" data-initlng="' . Params::param('initLng') . '" data-initlng="' . Params::param('initZoom') . '">
                            ' . $label . '
                            ' . $showHideMap . '
