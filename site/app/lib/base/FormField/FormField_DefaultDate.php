...
class FormField_DefaultDate
{
    ...
    public static function create($options)
    {
        ...
        $checkbox = (isset($options['checkboxDate']) && $options['checkboxDate'] == 'true') ? FormField_Checkbox::create(['name' => 'check_' . $options['name'], 'value' => $checkboxVal, 'class' => 'checkBoxInlineDate']) : '';
        $checkboxHidden = (isset($options['checkboxDate']) && $options['checkboxDate'] == 'true') ? FormField_Hidden::create(['name' => 'checkhidden_' . $options['name'], 'value' => "1"]) : '';
        $checkboxClass = (isset($options['checkboxDate']) && $options['checkboxDate'] == 'true') ? 'select_checkbox' : '';
